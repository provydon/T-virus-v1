...
<!--[if IE 9 ]><html class="ie9"><![endif]-->
    <head>
        ...
        <link rel="shortcut icon" href="/../images/main_logo_alone.png" type="image/x-icon">
        <link rel="apple-touch-icon" sizes="180x180" href="/../images/main_logo_alone.png">
        <link rel="icon" type="image/png" href="/../images/main_logo_alone.png" sizes="32x32">
        <link rel="icon" type="image/png" href="/../images/main_logo_alone.png" sizes="16x16">
        <link rel="manifest" href="/../images/main_logo_alone.png">
        <link rel="mask-icon" href="/../images/main_logo_alone.png" color="#5bbad5">
        <title>
