@php
    if($admin_type == "h-s-admin"){
        $route = route('head-sub-admin-update-course');
    }
    elseif($admin_type == "admin"){
        $route = route('admin-update-course');
    }
   
@endphp

<form class="form-inline courses-form" id="courses-form" action="{{$route}}" method="post">
    {{ csrf_field() }}
   
        <input type="hidden" name="country" id="hs_temp_country" value=""/>
   
        <input type="hidden" name="school" id="hs_temp_school" value=""/>
   
        <input type="hidden" name="faculty" id="hs_temp_faculty" value=""/>
   
        <input type="hidden" name="dept" id="hs_temp_dept" value=""/>
