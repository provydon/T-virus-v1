            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table id="data-table-basic" class="table table-striped">
                        ...
                        <tbody>
                            @if(isset($all_head_sub_admins))
                                @foreach($all_head_sub_admins as $key=>$sub_admins)
                                    @foreach($sub_admins as $key=>$row)
                                        <tr id="user_row_{{$row->id}}">
                                            ...
                                            <td id="user_{{$row->id}}">
                                                <button type="button" class="btn btn-danger btn-xs"  onclick="remove_head_sub_admin({{$row->id}})">remove</button>
                                            </td>
                                            <td>
                                                {{$row->first_name}}
                                            </td>
